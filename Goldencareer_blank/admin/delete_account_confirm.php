			...
			<div class="block-content collapse in">
				...
				?>
					...
					<p>Are you sure you want to delete your account?</p>
							...
							<a class="btn btn-danger btn-sm" role="button" href="delete_account_password_confirm.php?bid=<?php echo $bid; ?>"><span class="glyphicon glyphicon-plus"></span>Yes</a>
						
						
						
						
							<a class="btn btn-success btn-sm" role="button" href="welcome.php"><span class="glyphicon glyphicon-eye-open"></span>No</a>
